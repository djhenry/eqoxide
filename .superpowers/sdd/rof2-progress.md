...
## Log
- 2026-06-26: branch + roadmap created; eq-client-expert repointed to RoF2; decompiles (REDACTED-TOOL done, REDACTED-TOOL REDACTED-CLIENT pending). Starting Phase 1 opcode migration.
- 2026-06-26: Ghidra decompile COMPLETE — REDACTED-CLIENT.c (1.16M lines/34k fns), REDACTED-CLIENT.c, eqmain.dll.c at ~/eq_assets/everquest_rof2/redacted/REDACTED-TOOL/. expert has full RoF2 sources. Phase 1 opcode subagent still running.
