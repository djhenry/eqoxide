...
// See zone.wgsl's apply_fog for the rationale (RoF2 linear distance fog, eqoxide#517). Doors are
// also drawn with this pipeline (encode_door_pass), so they get fogged too — matching native.
