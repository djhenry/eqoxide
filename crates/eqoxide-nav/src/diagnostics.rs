...
//
// SpokeReading/ProbeAnchor/CastZ/Placement/ClearanceProbe/WaterDebug moved verbatim to
// eqoxide_zone_geometry::diagnostics (docs/specs/2026-09-21-agent-harness-separation-plan-
// zone-geometry.md, Task 2): Collision::body_placement/clearance_probe construct them and
// both moved SHARED, so the types have to live where their constructors do.
pub use eqoxide_zone_geometry::diagnostics::{
    CastZ, ClearanceProbe, Placement, ProbeAnchor, SpokeReading, WaterDebug,
};
