...
impl CommandState {
    ...
    pub fn take_merchant_buy(&self) -> Option<(u32, u32)> {
        self.dequeue(&self.merchant.buy)
    }
    ...
    pub fn take_open_await(&self) -> Option<(u32, oneshot::Sender<CommandResult<OpenOk>>)> {
        self.dequeue(&self.merchant.open_await)
    }
}
