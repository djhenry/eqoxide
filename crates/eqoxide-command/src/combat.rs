...
impl CommandState {
    ...
    pub fn take_cast_await(&self) -> Option<(CastRequest, oneshot::Sender<CommandResult<CastEnd>>)> {
        self.dequeue(&self.combat.cast_await)
    }
